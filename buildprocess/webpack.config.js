...
module.exports = function(devMode, hot) {
                    ...
                    use: [
                        {
                            ...
                            options: {
                                ...
                                replace: 'var _get = require(\'leylinesjs/lib/Core/superGet\').default;',
                                flags: 'g'
                            }
                        },
                        {
                        ...
                        //     options: {
                        //          transpileOnly: true
                        //         // configFile: path.resolve(__dirname, '..', 'node_modules', 'leylinesjs', 'tsconfig.json')
                        //     }
                        // }
                    ]
                },
    ...
    return configureWebpackForPlugins(
      configureWebpackForTerriaJS(path.dirname(require.resolve('leylinesjs/package.json')), config, devMode, hot, MiniCssExtractPlugin)
    );
};
